        ...
        return (
                <Col key={_id}>
                    <Card className='text-decoration-none phone'>
                        <Link to={`/phones/${_id}`}><Card.Img className='phone-image ' variant="top" src={image} /></Link>
                            <Card.Body>
                                <div className='d-flex justify-content-between align-items-center'>
                                <Card.Title className='fw-bolder phone-name'>{title}</Card.Title>
                                </div>
                                <Card.Text className='phone-desc'>
                                    {description.slice(0, 120)}... <Link className='text-decoration-none' to={`/phones/${_id}`}>View Details...</Link>
                                </Card.Text>
                            </Card.Body>
                    </Card>
                </Col>
